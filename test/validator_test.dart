...
main() {
  ...
  test('IsCreditCard', () {
    check(
        validator: (val) => v.isCreditCard(val),
        valid: [
          '375556917985515',
          '36050234196908',
          '4716461583322103',
        ...
        invalid: ['5398228707871528', '', 'Lol0']
    );
  });

  test('IsISBN', () {
    check(
        validator: (val) => v.isISBN(val, 10),
        valid: [
          '3836221195',
          '3-8362-2119-5',
          '3 8362 2119 5',
